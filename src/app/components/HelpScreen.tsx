...
import { ArrowLeft, HelpCircle, MessageCircle, Mail, Phone, FileText, ChevronRight } from 'lucide-react';
...
export default function HelpScreen() {
  ...
  const faqItems = [
    {
      question: 'Làm sao để đặt lịch đăng kiểm xe?',
      answer: 'Vào màn hình Đặt lịch, chọn xe, địa điểm và thời gian, sau đó xác nhận đặt lịch.',
    },
    {
      question: 'Tôi có thể thay đổi lịch hẹn không?',
      answer: 'Có, bạn có thể thay đổi hoặc hủy lịch hẹn trong mục Đơn hàng trước 24 giờ.',
    },
    {
      question: 'Làm sao để theo dõi nhân viên?',
      answer: 'Sau khi đặt lịch, vào mục Đơn hàng và chọn "Theo dõi" để xem vị trí nhân viên real-time.',
    },
    {
      question: 'Phương thức thanh toán nào được hỗ trợ?',
      answer: 'Chúng tôi hỗ trợ thanh toán qua VietQR, thẻ tín dụng/ghi nợ và ví điện tử.',
    },
    {
      question: 'Làm sao để nhận hóa đơn?',
      answer: 'Hóa đơn sẽ được gửi qua email sau khi thanh toán thành công và có trong mục Đơn hàng.',
    },
  ];
  ...
  const contactMethods = [
    {
      ...
      description: 'Trò chuyện với bộ phận hỗ trợ',
      color: 'blue',
      action: () => toast.info('Tính năng đang được phát triển'),
    },
    {
      icon: Mail,
      title: 'Email',
      description: 'support@dangkiem.vn',
      color: 'green',
      action: () => window.location.href = 'mailto:support@dangkiem.vn',
    },
    {
      icon: Phone,
      title: 'Hotline',
      description: '1900 xxxx (24/7)',
      color: 'orange',
      action: () => window.location.href = 'tel:1900xxxx',
    },
  ];
  ...
  return (
    <div className="h-screen bg-gray-50 flex flex-col max-w-md mx-auto">
      ...
      <div className="sticky top-0 z-40 bg-white px-5 pt-12 pb-4 rounded-b-[2rem] shadow-md border-b border-gray-100 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-gray-900 font-bold flex-1">Trợ giúp</h1>
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5 pb-24">
        {/* Contact Methods */}
        <div className="mb-5">
          <h2 className="text-gray-900 font-bold text-sm mb-3 px-1">Liên hệ hỗ trợ</h2>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 text-left">
                      <p className="font-semibold text-gray-900 text-sm mb-0.5">{method.title}</p>
        ...
        {/* FAQ Section */}
        <div className="mb-5">
          <h2 className="text-gray-900 font-bold text-sm mb-3 px-1">Câu hỏi thường gặp</h2>
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            {faqItems.map((item, index) => (
              <details
                key={index}
                className={`group ${index !== faqItems.length - 1 ? 'border-b border-gray-100' : ''}`}
              >
                <summary className="flex items-center justify-between p-4 cursor-pointer hover:bg-gray-50 transition-colors list-none">
                  ...
                  <ChevronRight size={20} className="text-gray-400 flex-shrink-0 group-open:rotate-90 transition-transform" />
                </summary>
        ...
        {/* User Guide */}
        <div className="mb-5">
          <h2 className="text-gray-900 font-bold text-sm mb-3 px-1">Tài liệu hướng dẫn</h2>
          <button
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 text-left">
                <p className="font-semibold text-gray-900 text-sm mb-0.5">Hướng dẫn sử dụng</p>
                <p className="text-gray-500 text-xs">Tài liệu chi tiết về các tính năng</p>
              </div>
              <ChevronRight size={20} className="text-gray-400 flex-shrink-0" />
            </div>
          </button>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-green-50 border border-blue-200 rounded-2xl p-4">
          <div className="text-center">
            ...
            <p className="text-gray-900 font-bold mb-1">Ứng dụng Đăng Kiểm</p>
            <p className="text-gray-600 text-sm mb-2">Phiên bản 1.0.0</p>
            <p className="text-gray-500 text-xs">© 2026 Hệ thống Đăng Kiểm Việt Nam</p>
          </div>
        </div>
      </div>
