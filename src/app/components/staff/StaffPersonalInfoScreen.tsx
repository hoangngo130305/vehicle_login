...
export default function StaffPersonalInfoScreen() {
  ...
  const [formData, setFormData] = useState({
    ...
    email: user?.email || 'nguyenvana@dangkiem.vn',
    phone: user?.phone || '0901234567',
    address: '123 Nguyễn Trãi, Q.1, TP.HCM',
    birthDate: '1990-01-15',
    idNumber: '079090001234',
    position: 'Nhân viên đăng kiểm',
    department: 'Phòng đăng kiểm xe cơ giới',
  });
  ...
  const handleSave = () => {
    ...
    setTimeout(() => navigate('/staff/profile'), 500);
  };
      ...
      <div className="sticky top-0 z-40 bg-white px-5 pt-12 pb-4 rounded-b-[2rem] shadow-md border-b border-gray-100 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={handleSave}
              className="flex items-center gap-1.5 px-4 py-2 bg-green-600 text-white rounded-xl font-semibold hover:bg-green-700 transition-colors text-sm"
            >
              <Save size={16} />
              Lưu
            </button>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white text-gray-900"
            />
          </div>
